...
def home():
    ...
    with col2:
        ...
        for item in cartitems:
            category_name, item_name = item.split(',')
            image_path = f"Images/{item_name.replace(' ', '_')}.jpeg"  # Replace with your image format
            # image_path = "Images/tomato.jpeg"
            price = categorieswise_price_dict[category_name][item_name]
            col1, col2, col3 = st.columns(3)
            with col1:
                # st.write(f"{category}: {item_name}")
        ...
        #     image_path = f"images/{item_name.replace(' ', '_')}.jpg"  # Replace with your image format
...
def main():
    ...
    page = st.sidebar.radio("Select a page", ["Home", "Select Location", "Account & Profile", "Orders", "Cart"])
